<template>
    <div class="min-h-screen flex flex-col bg-gray-100">
      ...
      <div class="flex flex-grow">
        ...
        <div class="flex-grow py-6 md:py-10 px-6 md:px-10">
          ...
          <div v-if="activePage === 'Profile'">
            <div class="flex justify-between items-center mb-4">
              <h3 class="text-lg font-semibold text-purple-900">Employee Profile</h3>
              <button
        ...
        -->
          ...
          <div v-if="activePage === 'Your Travels'">
            <div class="flex justify-between items-center mb-4">
         ...
         <!-- Employee Visits Section -->
            <div v-if="activePage === 'Appointments'">
            <div class="flex justify-between items-center mb-4">
  ...
  const menuItems = [
    ...
    { label: 'Your Travels', icon: 'bx-car' },
    { label: 'Appointments', icon: 'bx-pen' },
    { label: 'Deliveries', icon: 'bx-package' },
  ];
  
  const widgets = [
   
    { title: 'Travels', text: 'Pending Approval: 5', icon: 'bx-car' },
